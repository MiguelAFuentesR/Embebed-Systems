...
#pragma pack(push, 1)
uint8_t RemoteXY_CONF[] =   // 654 bytes
{ 255, 1, 0, 57, 2, 135, 2, 16, 30, 4, 131, 5, 89, 46, 21, 6, 1, 12, 88, 83,
  ...
  111, 114, 32, 53, 0, 129, 0, 68, 15, 12, 5, 4, 24, 109, 98, 97, 114, 0, 67, 1,
  ...
  0, 24, 26, 11, 67, 1, 90, 8, 5, 3, 0, 24, 26, 11
};
...
void Actualizar_Datos() {
  ...
  RemoteXY.Barra_Presion = (int)(Sensor_Presion) ;
